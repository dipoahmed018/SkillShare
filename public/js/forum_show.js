...
function Image_picker(content) {
  ...
  if (images.length > limit) {
    e.preventDefault();
    return "You can not upload more then ".concat(limit, " image");
  }
...
function Filter_length(content) {
  ...
  if (content.length > 1500) {
    e.preventDefault();
    return "question must be completed under ".concat(limit, " charecters");
  }
...
function Inject_images(images) {
  ...
  if (forum instanceof Element || forum instanceof HTMLDocument) {
    ...
    var fourm_element = document.getElementById(forum);
...
var modal_opener = function modal_opener(e) {
  ...
  if (action == 'create') {
    ...
    url = "/".concat(comment_id, "/comment/update");
...
comment_form.addEventListener('submit', function (e) {
  e.preventDefault(); //sources is the object for storing the image urls
  ...
  var form_data = {}; //change details of form_data based on action type
  ...
  form_data = JSON.stringify(form_data); //make the request to server
...
/* harmony import */ var _asset_CkEditorHelper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../asset/CkEditorHelper */ "./resources/js/asset/CkEditorHelper.js");
...
var show_questions = document.getElementById('show-questions');
var show_posts = document.getElementById('show-posts');
var posts_box = document.querySelector('.posts-box');
var questions_box = document.querySelector('.questions-box');
var popup = new _asset_PopupHandler__WEBPACK_IMPORTED_MODULE_2__.default();
var modal = new bootstrap__WEBPACK_IMPORTED_MODULE_1__.Modal(modal_element); //this images variable holds the images for post creation

var images = {}; //show the editor on button click and editor is the holder for ck editor instance
...
post_image.addEventListener('change', function (e) {
  ...
  _toConsumableArray(e.target.files).forEach(function (image) {
    if (image.size > 1024 * 1027 * 2) {
      popup.addPopup("This '".concat(image.name, "' file is larger than 2mb."));
      return;
    }
...
show_questions.addEventListener('click', function (e) {
