...
var chunk_upload = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(file, url) {
    var inputs,
        chunksize,
        uploaded,
        filesize,
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            inputs = _args.length > 2 && _args[2] !== undefined ? _args[2] : {};
            chunksize = _args.length > 3 && _args[3] !== undefined ? _args[3] : 1024 * 1024 * 3;
...
function uploader(url, data) {
  ...
  return new Promise(function (resolve, reject) {
    axios__WEBPACK_IMPORTED_MODULE_1___default().post(url, data, config).then(function (res) {
