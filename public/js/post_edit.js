...
(() => {
/*!**********************************************!*\
  !*** ./resources/js/pagescript/post_edit.js ***!
  \**********************************************/
__webpack_require__.r(__webpack_exports__);
...
var ck_submit_handler = function ck_submit_handler(e, editor) {
  //parse the content of text question_editor to html for filtering and picking the image urls
  var data = editor.getData();
  var images = (0,_asset_CkEditorHelper__WEBPACK_IMPORTED_MODULE_0__.Image_picker)(data);
  var filter = (0,_asset_CkEditorHelper__WEBPACK_IMPORTED_MODULE_0__.Filter_length)(data);

  if (_typeof(images) === 'object' && images) {
    (0,_asset_CkEditorHelper__WEBPACK_IMPORTED_MODULE_0__.Inject_images)(images, 'images', e.target);
  }
