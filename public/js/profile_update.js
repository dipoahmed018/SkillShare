...
function pagescripts() {
  //form default handel
  var image_form = document.getElementById('user_update_form_image');
  var name_form = document.getElementById('user_update_form_name');
  ...
  var image_preview = document.getElementById('image_crop_preview');
  image_preview.classList.add('hide');

  var startCropper = function startCropper(event) {
    //get upload image
    var image = event.target.files[0];
    image_preview.classList.add('hide'); //error handle

    var error_box = document.getElementById('profile_picture_scripterror');
    error_box.innerText = '';
    ...
    var cropper = new (cropperjs__WEBPACK_IMPORTED_MODULE_1___default())(image_crop, {
      viewMode: 1,
      autoCrop: true,
      movable: false,
      minCropBoxWidth: 200,
    ...
    var cancel = document.getElementById('cancel_upload_image');
    var upload = document.getElementById('upload_image'); //cancel handel
